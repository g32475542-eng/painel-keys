...
// ========== AUTENTICAÇÃO BÁSICA com variáveis de ambiente ==========
// Defina estas variáveis no Render/Glitch:
// ADMIN_USER, ADMIN_PASS, SOCIO_USER, SOCIO_PASS
...
app.post("/api/keys", (req, res) => {
  ...
  if (!key || !duracaoSegundos) {
    return res
      .status(400)
      .json({ error: "Faltam dados: key e duracaoSegundos são obrigatórios" });
  }
